- title:: [[Xenocortex]] System
- type:: : lore
- campaign:: : [[kepharion]]
- category:: [[bio-crystalline]], consciousness
- tags:: : #[[kepharion]] #[[xenocortex]] #[[bio-crystalline]] #consciousness #[[xenocortex]]-system
...
- ### [[Xenocortex]] Encoding Rules
- **Rest Requirements**: 8 hours to encode simple behaviors, 24+ hours for complex patterns
- **Pattern Slots**: Characters have limited [[xenocortex]] capacity based on Constitution
- **Encoding Ritual**: Players can choose which successful actions to crystallize during rest
- **Pattern Conflicts**: Contradictory patterns cause mental strain (Wisdom saves)

- ### Character Creation
- **[[Xenocortex]] Rating**: 1-5, determines pattern storage capacity
- **Cultural Background**: Pattern-Breaker, Pattern-Holder, or Harmony Walker
- **Starting Patterns**: Begin with 1-3 encoded behaviors from background