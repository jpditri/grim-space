...
- Touches or references The Black Book during important conversations
- Shows disturbing calm when discussing violence or sacrifice
- Eyes occasionally seem to look through people rather than at them

**Speech Patterns**:
- "The old powers have chosen me to herald their return."
...
**INT**: 18 (+4) **WIS**: 8 (-1) **CHA**: 16 (+3)

**Saving Throws**: Int +7, Cha +6
**Skills**: Arcana +10, Deception +6, History +7, Investigation +7, Persuasion +6
**Languages**: English, Latin (from The Black Book), Abyssal (learned from entities)
**Damage Resistances**: Psychic

**Spellcasting**: Uses The Black Book as focus, spell save DC 15, +7 to hit
**Spell Slots**: 4 1st, 3 2nd, 3 3rd, 1 4th
**Spells Known**:
- *Cantrips*: Eldritch Blast, Minor Illusion, Prestidigitation, Thaumaturgy
- *1st Level*: Charm Person, Command, Protection from Evil and Good
- *2nd Level*: Hold Person, Suggestion, Detect Thoughts
- *3rd Level*: Counterspell, Fear, Hunger of Hadar
- *4th Level*: Summon Aberrant Horror (custom spell)

**Special Abilities**:
- **Black Book Connection**: Can cast spells without spell slots 1/day per spell level
- **Entity Communication**: Can speak with Valkraise and summoned horrors
- **Corrupting Presence**: Creatures within 30 feet must save or be influenced toward evil
- **Supernatural Charisma**: Advantage on Persuasion checks against creatures with Int 8+

**Legendary Actions** (3 per turn, only when holding The Black Book):
- Move without provoking opportunity attacks
- Cast a cantrip
- Cast a 1st or 2nd level spell (costs 2 actions)

---

*"You think you understand what you're dealing with, but you see only the surface ripples of a cosmic tide. I have gazed into the spaces between realities and heard the whispers of entities that predate your gods. When Valkraise walks this earth, when the barriers crumble and the old powers return, you'll understand that everything I've done was necessary. Abigail understands. Soon, everyone will."*